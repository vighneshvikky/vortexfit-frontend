  ...
  import { Observable, catchError, switchMap, throwError, of, BehaviorSubject, filter, take } from 'rxjs';
  ...
  export class TokenInterceptor implements HttpInterceptor {
    ...
    private cloneRequestWithToken(request: HttpRequest<unknown>): HttpRequest<unknown> {
